...
function to the `createResponsiveStateReducer` configuration object as the `extraFields` key.
This function receives an object with the responsive state and returns an object
